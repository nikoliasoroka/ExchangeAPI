        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwoFactorEnd = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessRights", x => new { x.RoleId, x.ActionTypeId });
                    table.ForeignKey(
                        name: "FK_dbo.AccessRights_dbo.ActionType_ActionTypeId",
                        column: x => x.ActionTypeId,
                        principalTable: "ActionType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_dbo.AccessRights_dbo.AspNetRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbo.AspNetUserLogins", x => new { x.UserId, x.ProviderKey, x.LoginProvider });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRights_ActionTypeId",
                table: "AccessRights",
                column: "ActionTypeId");
